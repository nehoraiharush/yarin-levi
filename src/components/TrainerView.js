...
const TrainerView = ({ disable, toggleSidebar, trainer, setTrainer }) => {
      ...
      try {
        ...
        dispatch({
          ...
          payload: {
            trainersList: [
              ...trainersList.filter(
                (trainerA) => trainerA.name !== trainer.name
              ),
              trainer,
            ],
          },
  ...
  const handleDateChange = async (e) => {
    ...
    if (meetingsDict[dateInput.current.value]) invokeModal(true);
  };
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  ...
                  {!disable ? (
                    <input
                      ...
                      ref={dateInput}
                      type='date'
                      value={trainer.nextMeeting}
                      onChange={handleDateChange}
                    />
                  ) : (
                    <h4 style={{ color: 'lightblue' }}>
                      <u>{trainer.nextMeeting}</u>
                    </h4>
                  )}
                </div>
          ...
          <Row style={{ padding: '10px' }}>
            <CustomeModal
              ...
              bodyTitle={
                <h4>
                  פגישות בתאריך:{' '}
                  {dateInput.current ? dateInput.current.value : ''}
                </h4>
              }
              body={
                <>
                  {dateInput.current &&
                    ...
                    meetingsDict[dateInput.current.value].map((name, index) => {
                                ...
                                onChange={(e) => {
                                  ...
                                  changeTrainerData({
                                    ...
                                    cardioInfo: {
                                      ...
                                      calories: [
                                        value,
                                        trainer.cardioInfo.calories[1],
                                      ],
                                    },
                                  });
                                }}
                                value={trainer.cardioInfo.calories[0]}
                                ...
                                onChange={(e) => {
                                  ...
                                  changeTrainerData({
                                    ...
                                    cardioInfo: {
                                      ...
                                      timesAweek: [
                                        value,
                                        trainer.cardioInfo.timesAweek[1],
                                      ],
                                    },
                                  });
                                }}
                                value={trainer.cardioInfo.timesAweek[0]}
                                style={{ border: 'none', width: '100%' }}
                              />
                            </td>
                          </tr>
                          {Array.isArray(trainer.cardioInfo.calories) && (
                            <tr>
                              <td>
                                <input
                                  disabled={disable}
                                  onChange={(e) => {
                                    ...
                                    changeTrainerData({
                                      ...
                                      cardioInfo: {
                                        ...trainer.cardioInfo,
                                        calories: [
                                          trainer.cardioInfo.calories[0],
                                          value,
                                        ],
                                      },
                                    });
                                  }}
                                  value={trainer.cardioInfo.calories[1]}
                                  style={{ border: 'none', width: '100%' }}
                                />
                              </td>
                              <td>
                                  ...
                                  onChange={(e) => {
                                    ...
                                    changeTrainerData({
                                      ...
                                      cardioInfo: {
                                        ...trainer.cardioInfo,
                                        timesAweek: [
                                          trainer.cardioInfo.timesAweek[0],
                                          value,
                                        ],
                                      },
                                    });
                                  }}
                                  value={trainer.cardioInfo.timesAweek[1]}
                                  style={{ border: 'none', width: '100%' }}
                                />
                              </td>
                            </tr>
                            ...
                            <Button
                              onClick={() => {
                                changeTrainerData({
                                  ...
                                  cardioInfo: {
                                    ...trainer.cardioInfo,
                                    calories: [trainer.cardioInfo.calories, 0],
                                    timesAweek: [
                                      trainer.cardioInfo.timesAweek,
                                      0,
                                    ],
                                  },
                                });
            ...
            >
              <PlanInfoCard id={trainer.id} type='trainingPlan' />
            </Col>
            <Col
              lg={3}
              style={{
            ...
            >
              <PlanInfoCard id={trainer.id} type='nutrition' />
            </Col>
          </Row>
        </>
      ) : (
